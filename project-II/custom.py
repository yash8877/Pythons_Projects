...
btnTotal = Button(f1, padx=16, pady=8, bd=16, fg="black",
                  font=('arial', 16, 'bold'), cursor="hand2", width=10,
...
btnExit = Button(f1, padx=16, pady=8, bd=16,
                 fg="black", cursor="hand2", font=('arial', 16, 'bold'),
                 width=10, text="Exit", bg="red",
                 command=qExit).grid(row=7, column=3)

btnlogout = Button(f1, bd=12, fg="black", cursor="hand2", font=(
    'arial', 16, 'bold'), width=10, text="Logout", bg="green", command=logout).place(x=20, y=180)
